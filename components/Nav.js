...
export const navData = [
  { name: "Asosiy", path: "/", icon: <HiHome /> },
  { name: "Biz haqimizda", path: "/about", icon: <HiUser /> },
  { name: "Xizmatlar", path: "/services", icon: <HiRectangleGroup /> },
  { name: "Loyihalar", path: "/work", icon: <HiViewColumns /> },
  {
    name: "Izohlar",
    path: "/testimonials",
